    ...
    return (
      <Router history={newHistory}>
        <Switch>
          ...
          <Route path="/courier/:orderId" component={courier} />
          <Route path="/dfkDetail/:orderId" component={dfkDetail} />
          <Route path="/dljDetail/:orderId" component={dljDetail} />
          <Route path="/payDetail/:orderId" component={payDetail} />
